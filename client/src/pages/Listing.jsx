    ...
    <main>
      ...
      {listing && !loading && !error && (
        <div>
         ...
         />
          {hoverVisible&&(<div className='absolute bottom-full mb-2 px-2 py-1 text-xs text-white bg-red-950 rounded opacity-0 group-hover:opacity-100 transition-opacity'>
           Share this page
          </div>)
        }
         </div>
